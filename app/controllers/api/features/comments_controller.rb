class Api::Features::CommentsController < ApplicationController
    def index
        ...
        render json: { comments: @comments, message: "Comments of Earthquake feature" }, status: 200
    end 

    def create
        @comment = Comment.new(earthquake_id: params[:feature_id], description: params[:description])
